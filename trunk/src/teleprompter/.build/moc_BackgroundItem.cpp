...
static const char qt_meta_stringdata_BackgroundItem[] = {
    "BackgroundItem\0"
};

const QMetaObject BackgroundItem::staticMetaObject = {
    { &AbstractVisualItem::staticMetaObject, qt_meta_stringdata_BackgroundItem,
      qt_meta_data_BackgroundItem, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BackgroundItem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BackgroundItem))
        return static_cast<void*>(const_cast< BackgroundItem*>(this));
