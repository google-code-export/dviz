	...
	m_ui(new Ui::MainWindow)
{
	...
	// TODO rewrite output managmenet as:
	// * OutputWidget objects (with a setOutputInfo(Output*) method)
	// * MainWindow stores QList<OutputWidget*> list which is built in setupOutputViews()
	// This below right now is just a temporary "hack" till I write that infrastructure.
