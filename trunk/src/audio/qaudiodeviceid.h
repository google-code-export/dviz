...
class  QAudioDeviceId
{
    ...
    friend  QDataStream &operator<<(QDataStream&, const QAudioDeviceId&);
    friend  QDataStream &operator>>(QDataStream&, QAudioDeviceId&);
...
private:
 ...
 QDataStream &operator<<(QDataStream&, const QAudioDeviceId&);
 QDataStream &operator>>(QDataStream&, QAudioDeviceId&);
#endif
