...
void ImportGroupDialog::browse()
{
	...
	QString fileName = QFileDialog::getOpenFileName(this, tr("Select DViz File to Import From"), curFile, tr("DViz File (*.divz, *.dvz);;DViz XML File (*.dvizx *.dvx *.xml);;Any File (*.*)"));
	if(fileName != "")
	{
